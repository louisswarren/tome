...
--
open import Ensemble renaming ([_] to here)
open import Agda.Builtin.Equality

dne⊃lem : [ DNE ] ⊃ LEM
dne⊃lem (A ∷ []) = close
                    -- Agda auto doesn't support literals, so sadly this was done by hand
                    (∅ ∪ (¬ (lem A) ~ ((here refl -∷ ∅) ∪ (A ~ (((A ∷ here refl) -∷ ∅) ∪ (here refl -∷ ∅)))))) (
                    (arrowelim (axiom 0 (lem A ∷ [])) (arrowintro (¬ (lem A))
