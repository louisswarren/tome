MINTED=_minted.Decidable.gen _minted.Nat.gen _minted.List.gen _minted.Vec.gen _minted.Formula.gen _minted.Ensemble.gen _minted.Deduction.gen _minted.equivalence.gen _minted.Scheme.gen _minted.drinkerexample.gen _minted.no-ensemble.gen _minted.no-ensemble-quasi.gen _minted.Texify.gen
...
clean:
	rm -f *.agdai
	rm -f  *.gen agda.sty tome.aux tome.bbl tome.blg tome.log tome.out tome.pdf
